...
VillageState.prototype.preload = function() {
  ...
  this.game.load.image('map', 'images/collection_minigame/land.png');
  this.game.load.image('taskbar', 'images/main/taskbar.png');
  this.game.load.image('player', 'images/bunnykid.png');
  this.game.load.image('giraffe_doctor', 'images/doctor_minigame/giraffedoctor.png');
  this.game.load.image('mayor', 'images/main/owlmayor.png');
};
...
VillageState.prototype.create = function() {
  ...
  this.doctor = this.game.add.sprite(0, 0, 'giraffe_doctor');
